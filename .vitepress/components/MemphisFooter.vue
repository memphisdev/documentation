...
.edit-link-button:hover {
  ...
  .edit-icon path.paper {
    stroke: var(--vp-c-brand);
  }

  .edit-icon path.pencil {
    fill: var(--vp-c-brand);
  }
}
