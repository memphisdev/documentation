<template>
  <a class="card" :href="link" :target="link_target">
    <div class="background">
      <img
        data-type="cloud"
        v-if="type == 'Quick start: Cloud'"
        src="/assets/cloud_quick_start.svg"
        alt=""
      />
      <img
        data-type="source"
        v-if="type == 'Quick start: Open-Source'"
        src="/assets/open_source_quick_start.svg"
        alt=""
      />
    </div>
    <div class="card-text">
